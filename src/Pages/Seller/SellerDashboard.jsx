...
import { FaStar, FaArrowRight, FaUserAlt, FaCalendarAlt, FaBullhorn, FaVideo } from "react-icons/fa";
      ...
      <div className="flex bg-gray-50 min-h-screen p-6">
        ...
        <aside className="w-64 bg-white p-5 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="flex flex-col items-center text-center mb-6 pb-6 border-b border-gray-100">
            ...
            <h2 className="text-lg font-bold text-gray-800">Abdul Raziq</h2>
            <p className="text-gray-500 text-sm mt-1">@abdul_raziq</p>
            <Link
              to="/seller/Profile"
          ...
          {/* Level Overview with visual indicators */}
          <div className="text-left">
            <h3 className="font-bold text-gray-700 mb-4 flex items-center">
              <span className="bg-emerald-100 text-emerald-800 text-xs px-2 py-1 rounded mr-2">TOP RATED</span>
              Level Overview
            </h3>
        ...
        <main className="flex-1 ml-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900">Welcome back, Abdul!</h1>
